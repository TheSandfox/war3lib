	...
	struct Tip
		...
		static method init takes nothing returns nothing
			...
			*/"\n|cff999999사용 안함|r |cffffcc00-> 사거리 표시 ->|r |cff00ffff즉시 사용|r |cffffcc00순으로 변경됩니다.|r"
			...
			set TIPS[2] = AbilityProperty(CAST_TYPE_WEAPON).cast_type+"|cffffcc00는 동시에 한 종류만 사용할 수 있습니다.|r"
			set TIPS[3] = "|cffffcc00능력마다 최소 재사용 대기시간이 존재하며 해당 시간보다 재사용 시간을 적게 줄일 수 없습니다.|r"
			set TIPS[4] = "|cffffcc00캐릭터가 최초로 보유한 능력은 캐릭터의 레벨이 올라갈 때 마다 같이 레벨이 상승합니다.|r"
			set TIPS[5] = "|cffffcc00장착중인 |r"+AbilityProperty(CAST_TYPE_WEAPON).cast_type+"|cffffcc00 아이콘을 우클릭하여 장착 해제할 수 있습니다.|r"
			set TIP_MAX = 5
		endmethod

	...
	struct Tip
		...
		static method init takes nothing returns nothing
			...
			*/"\n|cff999999사용 안함|r |cffffcc00-> 사거리 표시 ->|r |cff00ffff즉시 사용|r |cffffcc00순으로 변경됩니다.|r"
			...
			set TIPS[2] = ABILITY_STRING_WEAPON+"|cffffcc00는 동시에 한 종류만 사용할 수 있습니다.|r"
			...
			set TIPS[5] = "|cffffcc00장착중인 |r"+ABILITY_STRING_WEAPON+"|cffffcc00 아이콘을 우클릭하여 장착 해제할 수 있습니다.|r"
			set TIP_MAX = 5
		endmethod

library Round
	...
	struct Round
		...
		static method init takes nothing returns nothing
			...
			/*라운드타이머*/
			set BACKDROP = BlzCreateFrame("MyTextBox",FRAME_ORIGIN,0,0)
			set TEXT = BlzCreateFrame("MyText",FRAME_ORIGIN,0,0)
			...
			set ICON = BlzCreateFrameByType("BACKDROP","",FRAME_ORIGIN,"",0)
			...
			set ROUND_BACKDROP = BlzCreateFrameByType("BACKDROP","",FRAME_ORIGIN,"",0)
			...
			set ROUND_TEXT = BlzCreateFrame("MyText",FRAME_ORIGIN,0,0)
